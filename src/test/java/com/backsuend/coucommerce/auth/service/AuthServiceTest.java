...
class AuthServiceTest {
    ...
    class RegisterTests {
        ...
        void register_withExistingEmail_shouldThrowBusinessException() {
            ...
            // When & Then
            BusinessException exception = assertThrows(BusinessException.class, () -> authService.register(signupRequest));
    ...
    class RefreshTokenTests {
        ...
        void refreshAccessToken_withValidToken_shouldReturnNewTokens() {
            ...
            UserDetailsImpl userDetails = UserDetailsImpl.build(member);
            RefreshTokenService.RefreshTokenInfo refreshTokenInfo = new RefreshTokenService.RefreshTokenInfo(email, member.getId(), false);
        ...
        void refreshAccessToken_withNonExistentToken_shouldThrowException() {
            ...
            // When & Then
            BusinessException exception = assertThrows(BusinessException.class, () -> authService.refreshAccessToken(nonExistentToken));
